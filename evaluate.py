...
context_qa_evaluator = LangChainStringEvaluator("context_qa", config={"llm": llm})
cot_qa_evaluator = LangChainStringEvaluator("cot_qa", config={"llm": llm})
...
evaluate(
  ...
  experiment_prefix="rag-qa-databricks",
